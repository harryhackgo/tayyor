...
const FeaturesData = [
  {
    ...
    link: "#",
    description:
      "Every restaurant has a story to tell, and we bring it to life through captivating videos.",
    aosDelay: "300",
  },
  {
    ...
    link: "#",
    description:
      "Safe money transactions are the backbone of our food ordering app, ensuring a secure and trustworthy experience for our users.",
    aosDelay: "500",
  },
  {
    name: "Easy to Use",
    ...
    link: "#",
    description:
      "Our food ordering app is designed with user-friendliness in mind, making it easy for anyone to navigate and place orders with just a few taps.",
    aosDelay: "700",
  },
];
